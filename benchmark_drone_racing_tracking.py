...
from traoptlibrary.traopt_utilis import rotm2euler, SE32manifSE3, se32manifse3, quatpos2SE3, quat2euler
...
q0 = SE3(
    position = -0.1 * np.ones((3,)) + q_ref[0][:3,3],
...
# Q_su2 = np.diag([ 
#     150., 75., 75., 750., 750., 750.,
#     50., 50., 50., 50., 50., 50. 
# ])
# Q_su2 = np.diag([ 
#     5000., 500., 500., 30., 30., 30.,
#     30., 30., 30., 2., 2., 2. 
# ])
# Q_su2 = np.diag([ 
