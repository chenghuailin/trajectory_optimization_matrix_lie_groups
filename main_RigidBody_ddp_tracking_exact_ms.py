...
from traoptlibrary.traopt_dynamics import SE3Dynamics, RigidBodyDynamics
...
dynamics = RigidBodyDynamics(J, dt, hessians=HESSIANS, debug=debug_dyn)
...
for step in range(N):
    ...
    rr.log(
        f"solution_rigidbody/drone_urdf",
        rr.Transform3D(
