...
from traoptlibrary.traopt_baseline import EmbeddedEuclideanSU2_MatrixNorm
...
ipopt_su2_unconstr_euc = EmbeddedEuclideanSU2_MatrixNorm( q_ref, xi_ref, dt, J, Q, R )
